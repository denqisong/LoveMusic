...
public class SlidingDeleteListView extends ListView implements OnScrollListener {
	...
	private MyListViewOnTouchEvent mListViewOnTouchEvent = null;
		...
		case MotionEvent.ACTION_DOWN:
			if (mEnableSlidingDelete) {// 横向滑动删除记录
				...
				if (position != INVALID_POSITION) {
					Song data = (Song)getItemAtPosition(position);
					try {
	 ...
	 * @Function:设置滚动方向监听
	 * */
	public void setMyListViewOnTouchEvent(MyListViewOnTouchEvent l) {
	 ...
	 * @Function:判断滚动方向监听
	 * */
	public interface MyListViewOnTouchEvent {
